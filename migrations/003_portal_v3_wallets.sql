-- FireSpot: Portal V3 anônimo, carteiras por estabelecimento e planos próprios
-- Compatível com MariaDB 10.3+ / MySQL 8+
-- Os valores padrão mantêm todos os hosts no fluxo atual.
...
CREATE TABLE IF NOT EXISTS partner_payment_plans (
  ...
  download_kbps INT UNSIGNED NOT NULL DEFAULT 0,
  upload_kbps INT UNSIGNED NOT NULL DEFAULT 0,
  active TINYINT(1) NOT NULL DEFAULT 1,
