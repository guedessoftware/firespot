...
$credentials = $_SESSION['portal_v3_subscriber_credentials'] ?? [];
if ((int)($credentials['partner_id'] ?? 0) !== (int)$partner['id']
    ...
    v3_fail('A credencial FIRENETWORK expirou. Tente conectar novamente.',403);
}
unset($_SESSION['portal_v3_subscriber_credentials']);
...
<body>
<main class="shell narrow"><section class="panel success-panel"><?=v3_brand_mark($theme)?><div class="success-icon">✓</div><h1>Conectando ao Wi-Fi…</h1><p class="muted">Seu benefício FIRENETWORK foi confirmado para este aparelho.</p></section></main>
